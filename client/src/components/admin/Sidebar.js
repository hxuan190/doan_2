...
const Sidebar = () => {
  ...
  return (
    <div className="flex-[0.2]">
      <div className="border-b border-gray-400 w-[3.5/4] ml-2 mb-4 mt-4"></div>
      <div className="bg-white  space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 h-[38.2rem]">
        <div className="">
          <NavLink
            to="/admin/home"
            className={({ isActive }) =>
